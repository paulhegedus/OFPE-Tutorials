...
![Open the Stack Builder and select your PostgreSQL server from the dropdwon.](postgres_setup/step_9a_windows.png)


![Select the PostGIS option in the Spatial Extension dropdown menu.](postgres_setup/step_9b_windows.png)


![Select Yes for all ensuing pop-ups.](postgres_setup/step_9c_windows.png)


![Select Finish to complete.](postgres_setup/step_9d_windows.png)
...
![Open the Stack Builder and select your PostgreSQL server from the dropdwon.](postgres_setup/step_9a_mac.png)


![Select the PostGIS option in the Spatial Extension dropdown menu.](postgres_setup/step_9b_windows.png)


![Select Next.](postgres_setup/step_9b_mac.png)


![Enter your Master Password.](postgres_setup/step_9c_mac.png)


![Hit Next.](postgres_setup/step_9d_mac.png)


![Hit Finish when the installation is complete.](postgres_setup/step_9e_mac.png)


![And hit Finish in the Stack Builder window.](postgres_setup/step_9f_mac.png)
...
![Open the *pgAdmin4* application to view your databases and servers.](postgres_setup/step_10a.png)


![You will need to select 'Reset Master Password' then enter your new master password for pgAdmin and select 'OK'.](postgres_setup/step_10b.png)

![Select the 'Servers' drop down in the left hand pane to activate the password pop up. Enter the password from Step 8 and check 'Save Password' then 'OK'. You may or may not see this error message.](postgres_setup/step_10c.png)

![The default 'postgres' database should be the only database visible.](postgres_setup/step_10d.png)

**10.** Now, we are ready to create our database. Go to the 'Object' tab, select 'Create', then 'Database...'.

![Select Object>>Create>>Database.](postgres_setup/step_11.png)
...
![Provide a database name.](postgres_setup/step_12.png)
